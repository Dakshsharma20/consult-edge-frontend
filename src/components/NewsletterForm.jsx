...
export default function NewsletterForm() {
  ...
  return (
    <form
      onSubmit={submit}
      className="bg-white/90 backdrop-blur-xl shadow-2xl rounded-2xl p-6 max-w-xl mx-auto border border-gray-200"
    >
      ...
      <div className="flex gap-2 items-center">
        ...
        <button
          className="px-5 py-3 bg-blue-600 hover:bg-blue-700 text-white 
                     rounded-xl font-semibold shadow-md transition active:scale-95"
        >
          Subscribe
        </button>
      </div>
